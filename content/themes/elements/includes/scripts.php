...
function enqueue_theme_scripts() {
  ...
  if( WP_DEBUG ):
    ...
    wp_enqueue_script( 'button', get_template_directory_uri() . '/js/button.js', 'jquery', false, true );
    wp_enqueue_script( 'incrementers', get_template_directory_uri() . '/js/incrementers.js', 'jquery', false, true );
    wp_enqueue_script( 'product-gallery', get_template_directory_uri() . '/js/product-gallery.js', 'jquery', false, true );
